const i18n = {
  ...
  hy: {
    meta_title: "Հարսանիք — Լուսինե և Անդրե",
    ...
    program_1: "Քաղաքացիական գրանցման արարողություն - նանսիի քաղաքապետարան",
    program_1_hint: "(Մուտքը՝ Ստանիսլաս հրապարակից)",
    program_2: "Պատվո գինու հյուրասիրություն  — Վանդելևիլի դղյակ",
    program_3: "Ընթրիք — Վանդելևիլի դղյակ",
